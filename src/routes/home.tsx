  ...
  return (
    <div className="flex-col w-full pb-24">
      <Container>
        <div className="my-8">
          <h2 className="text-3xl text-center md:text-center md:text-6xl">
            ...
            <br />
            Prepare your mind before the moment
          </h2>

          <p className="mt-4 text-muted-foreground text-sm" style={{ textAlign: 'center' }}>
        ...
        <div className="flex w-full items-center justify-evenly md:px-12 md:py-16 md:items-center md:justify-end gap-12">
          <p className="text-3xl font-semibold text-900 text-center">
            250k+
        ...
        {/* image section */}
        <div className="w-full mt-4 rounded-xl bg-gray-100 h-[600px] md:h-[700px] drop-shadow-md overflow-hidden relative">
          <img
            src="/img/a.png"
            alt=""
      ...
      <Container className="py-8 space-y-8">
        <h2 className="tracking-wide text-xl text-800 font-semibold">
